...
const Videos = () => {
    ...
    content = videos?.map((video) => {
      ...
      return (
        <tr key={id}>
          ...
          <td className="table-td ">{description.substring(0, 60)}...</td>
  ...
  const handleAddVideo = () => {
    navigate("/admin/videos/addVideo");
  };
        ...
        <div className="mx-auto max-w-full px-5 lg:px-20">
          <div className="px-3 py-20 bg-opacity-10">
            <div className="w-full flex">
              <button className="btn ml-auto" onClick={handleAddVideo}>
                Add Video
              </button>
            </div>
            <div className="overflow-x-auto mt-4">
              <table className="divide-y-1 text-base divide-gray-600 w-full">
                ...
                <tbody className="divide-y divide-slate-600/50 flex-nowrap">
                  {content}
                </tbody>
              </table>
            </div>
